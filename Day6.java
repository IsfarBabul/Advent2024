...
*/
    ...
    public static boolean guardMovement(ArrayList<ArrayList<String>> map, ArrayList<ArrayList<Integer>> guardLocations) {   //returns true if an infinite loop was found and false otherwise
        boolean isGuardPresent = true;
        while (isGuardPresent) {
            if (move(map, guardLocations)) {
                return true;
            }
            /*for (int i = 0; i < map.size(); i++) {
                System.out.println(map.get(i));
    ...
    public static boolean move(ArrayList<ArrayList<String>> map, ArrayList<ArrayList<Integer>> guardLocations) {
    ...
    public static boolean checkForInfiniteLoop(ArrayList<ArrayList<Integer>> guardLocations) {
